...
public class Basic2MessageHandler extends ChannelInboundHandlerAdapter {
    ...
    public Basic2MessageHandler(RequestThreadCacheData requestThreadCacheData, ResponseThreadCacheData responseThreadCacheData, ServiceThreadCacheData serviceThreadCacheData) {
