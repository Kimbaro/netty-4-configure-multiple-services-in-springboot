...
import com.bluechip.bcworkshinhanmessageq.modules.netty.core.NettyChannelInitializer;
...
public class NettyConfiguration {
    ...
    public InetSocketAddress inetSocketAddress() {
        LoggerFactory.getLogger(this.getClass()).info("(ง˙∇˙)ว [bc-work-shinhan-messageQ port {}] (ว˙∇˙)ง", port + "");
